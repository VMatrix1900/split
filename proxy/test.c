...
nat_lookup_cb_t nat_getlookupcb(const char *) __attribute__((warn_unused_result));
nat_socket_cb_t nat_getsocketcb(const char *) __attribute__((warn_unused_result));
...
nat_netfilter_lookup_cb(struct sockaddr *dst_addr, socklen_t *dst_addrlen,
                        int s,
                        struct sockaddr *src_addr, __attribute__((unused)) socklen_t src_addrlen)
{
 int rv;
...
static int
nat_iptransparent_socket_cb(int s)
{
 int on = 1;
 int rv;
