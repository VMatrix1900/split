...
void serv_writecb(struct bufferevent *bev, void *ptr)
{
    struct shm_ctx_t *ctx = (struct shm_ctx_t *)ptr;
...
void accept_conn_cb(struct evconnlistener *listener, evutil_socket_t fd,
                    struct sockaddr *address, int socklen, void *ptr)
{
    struct shm_ctx_t *ctx = (struct shm_ctx_t *)ptr;
...
{
    struct shm_ctx_t
        cli_shm_ctx;  // act as a client, receive msg from the server
    struct shm_ctx_t
        serv_shm_ctx;  // act as a server, receive msg from the client
    ...
    listener =
        evconnlistener_new_bind(base, accept_conn_cb, &serv_shm_ctx,
